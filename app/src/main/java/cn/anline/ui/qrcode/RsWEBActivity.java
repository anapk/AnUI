...
import cn.anline.ui.wxopen.AnimUtil;
import cn.anline.ui.wxopen.Constants;
import cn.anline.ui.wxopen.GetFromWXActivity;
import cn.anline.ui.wxopen.ShowFromWXActivity;
import cn.anline.ui.wxopen.Util;

public class RsWEBActivity extends Activity implements IWXAPIEventHandler {
    private ImageView iv_home,iv_menu,user,shop,code,business,linux,find,server,setting,search;
    private RelativeLayout level1, level2, level3;
    private Button button,button1,button2,button3,button4,button5;
    private WebView webView1;
    public boolean isShowLevel2 = true;// 是否显示2级菜单
    public boolean isShowLevel3 = true;// 是否显示3级菜单
    public boolean isShowMenu = true;// 是否显示整个菜单，包括1级，2级，3级的菜单

    private IWXAPI api;
//    String rsUrlValue = new String("");
//        Bundle extras = getIntent().getExtras();
//        String rsUrlValue = extras.getString("QRUrl");
    @Override
...
//                    String imgUrl = webView1.documentHasImages();
...
//                finish();
                ...
                case R.id.btn_qr_scan: {
                    ...
                    Intent goQRCode = new Intent(RsWEBActivity.this, ScannerActivity.class);
                ...
                case R.id.user:
                    Log.d("按钮","用户中心");
                    Toast.makeText(getApplicationContext(), "用户中心", Toast.LENGTH_SHORT).show();
                    break;
                case R.id.code:
                    Log.d("按钮","编程");
                    Toast.makeText(getApplicationContext(), "代码的世界", Toast.LENGTH_SHORT).show();
                    break;
                case R.id.shop:
                    Log.d("按钮","商店");
                    Toast.makeText(getApplicationContext(), "电子商城", Toast.LENGTH_SHORT).show();
                    break;
                case R.id.linux:
                    Log.d("按钮","Linux");
                    Toast.makeText(getApplicationContext(), "Linux世界", Toast.LENGTH_SHORT).show();
                    break;
                case R.id.business:
                    Log.d("按钮","商务");
                    Toast.makeText(getApplicationContext(), "商业与创业", Toast.LENGTH_SHORT).show();
                    break;
                case R.id.server:
                    Log.d("按钮","服务项目");
                    Toast.makeText(getApplicationContext(), "服务项目", Toast.LENGTH_SHORT).show();
                    break;
                case R.id.find:
                    Log.d("按钮","发现");
                ...
                case R.id.setting:
                    Log.d("按钮","设置");
                    Toast.makeText(getApplicationContext(), "程序设置", Toast.LENGTH_SHORT).show();
                    break;
                default:
                    break;
            }
...
//        返回键推出代码
        if (keyCode == KeyEvent.KEYCODE_BACK){
            AlertDialog.Builder builder = new AlertDialog.Builder(RsWEBActivity.this);
